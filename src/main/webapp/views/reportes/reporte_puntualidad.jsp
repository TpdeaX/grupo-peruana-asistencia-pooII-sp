...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Puntualidad | Grupo Peruana</title>
            ...
            <div class="page-header" style="flex-wrap: wrap; gap: 16px;">
                <div style="flex: 1;">
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <div>
                            <h1 style="font-family: 'Inter', sans-serif; font-weight: 600; font-size: 2rem; margin: 0;">Reporte de Puntualidad</h1>
                            <p style="color: var(--md-sys-color-secondary); margin-top: 4px; margin-bottom: 0;">Resumen de asistencias, tardanzas y faltas por empleado</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="compact-table" style="width: 100%; border-collapse: collapse;">
                            <thead>
                                <tr style="background: var(--md-sys-color-surface-container-low); border-bottom: 1px solid var(--md-sys-color-outline-variant);">
                                    ...
                                    <th style="text-align: center;">Min. Tardanza Total</th>
                                ...
                                <c:forEach var="row" items="${reporte}">
                                    <tr style="border-bottom: 1px solid var(--md-sys-color-outline-variant);">
                                        ...
                                        <td style="text-align: center;">
                                            <span class="stat-positive">${row.diasAsistidos}</span>
                                        </td>
                                        ...
                                        <td style="text-align: center;">
                                            <c:if test="${row.cantidadTardanzas > 0}">
                                                <span class="stat-warning" style="font-weight: bold;">${row.cantidadTardanzas}</span>
                                            </c:if>
                                            <c:if test="${row.cantidadTardanzas == 0}">-</c:if>
                                        </td>

                                        <td style="text-align: center;">
                                            <c:if test="${row.totalMinutosTardanza > 0}">
                                                <span class="stat-warning">${row.totalMinutosTardanza} min</span>
                                            </c:if>
