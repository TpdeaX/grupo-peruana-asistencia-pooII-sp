package com.grupoperuana.sistema.listeners;
 ...
 */
@WebListener
public class AppListener implements ServletContextListener, ServletContextAttributeListener, HttpSessionListener, HttpSessionAttributeListener, HttpSessionActivationListener, HttpSessionBindingListener, HttpSessionIdListener, ServletRequestListener, ServletRequestAttributeListener, AsyncListener {
	...
	/**
     * @see HttpSessionBindingListener#valueBound(HttpSess	ionBindingEvent)
     */
    ...
    public void contextDestroyed(ServletContextEvent sce)  { 
    	System.out.println("--- Deteniendo Aplicación: Limpiando recursos ---");

        try {
            AbandonedConnectionCleanupThread.checkedShutdown();
            System.out.println("MySQL AbandonedConnectionCleanupThread detenido.");
        } catch (Exception e) {
            e.printStackTrace();
        }
